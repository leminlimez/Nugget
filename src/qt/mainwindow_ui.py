...
#if QT_CONFIG(tooltip)
        self.wapicChk.setToolTip(QCoreApplication.translate("Nugget", u"Disables the service that deals with errors with Wi-Fi networks with Chinese characters in the name.", None))
#endif // QT_CONFIG(tooltip)
...
"Warning: Disabling will cause the battery to show \"Unknown Part\" or \"Unverified\" in Settings.", None))
        ...
        self.allowWifiApplyingChk.setText(QCoreApplication.translate("Nugget", u"Allow Applying Over Wi-Fi", None))
